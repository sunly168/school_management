...
function editRecord(id){
    var f=document.form;
    f.method="post";
    f.action='editRoom.jsp?id='+id;
    f.submit();
}
function deleteRecord(id){
    var f=document.form;
    f.method="post";
    f.action='deleteRoom.jsp?id='+id;
    f.submit();
}
</script>
...
<br/><br/><br/>
	...
	<form name="userform" method="post" action="AddRoom">
	<table width="330px" style="background-color:#EDF6EA;border:1px solid #000000;padding:5px;">
	<tr><td colspan=2 style="font-weight:bold;" align="center">Add Room</td></tr>
	...
	<%
		...
		String query = "select (count(roomid)+1) as newroomid from room";
	...
	<tr>
		...
		<td><input type="text" name="roomId" value=<%=rs.getInt(1)%> readonly></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name="roomName" value="" autofocus></td>
	</tr>	
	...
	<form method="post" name="form">
			<table border="1">
			<tr><th>Room Id</th><th>Room Name</th><th>Edit</th><th>Delete</th></tr>
			<%
			try{
			Class.forName(driver).newInstance();
			con = DriverManager.getConnection(url+db,userName,password);
