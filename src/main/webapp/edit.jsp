...
<table border="1">
<tr><th>User Id</th><th>User Name</th><th>Password</th></tr>
<%
...
String query = "select * from userlogin where userid='"+no+"'";
...
<td><input type="text" name="userpassword" value="<%=rs.getInt("userpassword")%>"></td>
</tr>
<tr>
<td colspan="3" align="right">	
	<input type="submit" name="Submit" value="Update" style="background-color:#49743D;font-weight:bold;color:#ffffff;">
	<input type="button" name="cancel" value="Cancel" style="background-color:#49743D;font-weight:bold;color:#ffffff;" onclick="window.location.href='userManagement.jsp'">
</td>
</tr>
<%
}
